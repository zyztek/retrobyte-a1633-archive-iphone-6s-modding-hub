  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[10000] bg-red-900/90 backdrop-blur-md flex items-center justify-center p-4 overflow-hidden"
      >
        ...
        <div className="w-full max-w-2xl border-4 border-white bg-black p-8 relative">
          <button 
            onClick={onClose}
